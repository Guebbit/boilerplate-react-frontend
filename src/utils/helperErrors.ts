...
export const zodErrorInterpreter = (parsedResult: ZodSafeParseError<Record<string, unknown>>) => {
...
export const notifyErrorMessages = (addMessage: (message: string) => unknown, error: unknown): void => {
